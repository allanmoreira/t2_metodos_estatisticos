...
<div class="jumbotron" id="div_home">
    <h1>T2 - Métodos Estatísticos</h1>
    <h2>Aluno: Allan Felipe Assis Moreira</h2>
    <p>
        Este trabalho tem como objetivo compreeender os conceitos da distribuição amostral e o teorema do limite central.
